    ...
    <div className="min-h-screen bg-background text-foreground page-transition animate-fade-in">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-1 animate-slide-up fade-hover">AI-Powered Academic Scheduler</p>
          <p className="text-gray-600 dark:text-gray-300 text-lg animate-slide-up fade-hover">Intelligent Timetable Generator for Educational Institutions</p>
        </div>
        ...
        {/* Instructions */}
        <Card className="mt-8 p-6 shadow-lg border-0 bg-background/80 dark:bg-background/90 border-indigo-200 dark:border-indigo-700 animate-slide-up card-hover animate-fade-in fade-hover custom-transition">
          <h4 className="font-medium mb-3 text-indigo-800 dark:text-indigo-200 fade-hover custom-transition">Getting Started</h4>
          <div className="space-y-2 text-sm text-gray-700 dark:text-gray-200 stagger-fade-in">
            <div className="flex items-center gap-2 fade-hover custom-transition">
