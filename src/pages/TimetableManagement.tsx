...
const TimetableManagement = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center animate-fade-in">
        <div className="text-center">
          <div className="rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4 animate-spin fade-hover"></div>
          <p className="text-gray-600 dark:text-gray-300 fade-hover">Loading data...</p>
        </div>
      </div>
    );
  }
